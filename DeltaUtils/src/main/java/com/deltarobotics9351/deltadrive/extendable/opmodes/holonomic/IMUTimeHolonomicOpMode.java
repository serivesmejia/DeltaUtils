...
import com.deltarobotics9351.deltadrive.extendable.linearopmodes.holonomic.IMUTimeHolonomicLinearOpMode;

/**
 * Remember to override setup() and define the 4 DcMotor variables in there!
 */
public class IMUTimeHolonomicOpMode extends IMUTimeHolonomicLinearOpMode {
