...
import com.deltarobotics9351.deltadrive.extendable.linearopmodes.holonomic.TimeHolonomicLinearOpMode;

/**
 * Remember to override setup() and define the 4 DcMotor variables in there!
 */
public class TimeHolonomicOpMode extends TimeHolonomicLinearOpMode {
