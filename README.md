...
### This library requires a SDK version of at least 5.3
...
```
3. Add the line `implementation 'com.github.DeltaRobotics-9351:DeltaUtils:v1.11.1-beta'` to TeamCode's `build.release.gradle`, inside the dependencies block
